...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, A as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, D as Certificate, F as lookupResultToBuffer, G as RequestStatusResponseStatus, H as UnknownError, I as RequestStatusDoneNoReplyErrorCode, J as RejectError, K as CertifiedRejectErrorCode, N as UNREACHABLE_ERROR, O as InputError, Q as InvalidReadStateRequestErrorCode, V as ReadRequestType, W as Principal, X as IDL, Y as MissingCanisterIdErrorCode, Z as HttpAgent, $ as encode, a0 as QueryResponseStatus, a1 as UncertifiedRejectErrorCode, a2 as isV3ResponseBody, a3 as isV2ResponseBody, a4 as UncertifiedRejectUpdateErrorCode, a5 as UnexpectedErrorCode, a6 as decode, d as Subscribable, a7 as pendingThenable, a8 as resolveEnabled, s as shallowEqualObjects, a9 as resolveStaleTime, f as noop, aa as environmentManager, ab as isValidTimeout, ac as timeUntilStale, ad as timeoutManager, ae as focusManager, af as fetchState, ag as replaceData, n as notifyManager, r as reactExports, i as shouldThrowError, e as useQueryClient, z as useInternetIdentity, ah as createActorWithConfig, ai as Record, aj as Opt, ak as Variant, al as Vec, am as Service, an as Func, ao as Text, ap as Nat, aq as Principal$1, ar as Tuple, as as Nat8, at as Bool, au as Int, av as Null } from "./index-icaUxuqU.js";
...
const WithdrawalId = Nat;
const WithdrawalStatus = Variant({
  "pending": Null,
  "completed": Null
});
const WithdrawalRequestPublic = Record({
  "id": WithdrawalId,
...
const UserProfilePublic = Record({
  ...
  "userId": UserId,
  "createdAt": Timestamp,
  "avatarStorageKey": Opt(ExternalBlob$1),
  "isPrivate": Bool,
  "followerCount": Nat,
  "followingCount": Nat
});
const VideoPublic = Record({
  "id": VideoId,
  "isPublished": Bool,
  "hashtags": Vec(Text),
  "createdAt": Timestamp,
  "storageKey": ExternalBlob$1,
  "caption": Text,
  "commentsCount": Nat,
  "likesCount": Nat,
  "viewsCount": Nat,
...
Service({
  ...
  "addComment": Func([VideoId, Text], [Comment], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "createWithdrawalRequest": Func(
    [Nat],
  ...
  "getCoinBalance": Func([], [Nat], ["query"]),
  "getComments": Func([VideoId], [Vec(Comment)], ["query"]),
  "getFeed": Func([Nat, Nat], [Vec(VideoPublic)], ["query"]),
  "getFollowers": Func([UserId], [Vec(UserProfilePublic)], ["query"]),
  "getFollowing": Func([UserId], [Vec(UserProfilePublic)], ["query"]),
  "getLikeCount": Func([VideoId], [Nat], ["query"]),
  "getMyReferralCode": Func([], [Text], []),
  "getRupeeEquivalent": Func([Nat], [Nat], ["query"]),
  "getTrendingHashtags": Func(
    [Nat],
    [Vec(Tuple(Text, Nat))],
    ["query"]
  ),
  ...
  "getUserVideos": Func([UserId], [Vec(VideoPublic)], ["query"]),
  "getVideo": Func([VideoId], [Opt(VideoPublic)], ["query"]),
  "getWithdrawalHistory": Func(
    [],
    [Vec(WithdrawalRequestPublic)],
    ["query"]
  ),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "isFollowing": Func([UserId], [Bool], ["query"]),
  "markWithdrawalCompleted": Func([WithdrawalId], [Bool], []),
  "recordAdWatch": Func([], [Nat], []),
  "recordDailyLogin": Func([], [Nat], []),
  "recordReferralReward": Func([Text], [Bool], []),
  "recordVideoView": Func([VideoId], [], []),
  "saveCallerUserProfile": Func(
    [Text, Text, Text, Bool],
    [],
    []
  ),
  "searchUsers": Func([Text], [Vec(UserProfilePublic)], ["query"]),
  "toggleLike": Func([VideoId], [Bool], []),
  "unfollowUser": Func([UserId], [Bool], []),
  "updateCallerAvatar": Func([ExternalBlob$1], [], []),
  "uploadVideo": Func(
    [ExternalBlob$1, Text, Vec(Text)],
    [VideoPublic],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const WithdrawalId2 = IDL2.Nat;
  const WithdrawalStatus2 = IDL2.Variant({
    "pending": IDL2.Null,
    "completed": IDL2.Null
  });
  const WithdrawalRequestPublic2 = IDL2.Record({
    "id": WithdrawalId2,
    "status": WithdrawalStatus2,
    "userId": UserId2,
    "createdAt": Timestamp2,
    "rupeeAmount": IDL2.Nat
  });
  ...
  const UserProfilePublic2 = IDL2.Record({
    ...
    "userId": UserId2,
    "createdAt": Timestamp2,
    "avatarStorageKey": IDL2.Opt(ExternalBlob2),
    "isPrivate": IDL2.Bool,
    "followerCount": IDL2.Nat,
    "followingCount": IDL2.Nat
  });
  const VideoPublic2 = IDL2.Record({
    "id": VideoId2,
    "isPublished": IDL2.Bool,
    "hashtags": IDL2.Vec(IDL2.Text),
    "createdAt": Timestamp2,
    "storageKey": ExternalBlob2,
    "caption": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "addComment": IDL2.Func([VideoId2, IDL2.Text], [Comment2], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "createWithdrawalRequest": IDL2.Func(
      [IDL2.Nat],
      [WithdrawalRequestPublic2],
      []
    ),
    ...
    "getCoinBalance": IDL2.Func([], [IDL2.Nat], ["query"]),
    "getComments": IDL2.Func([VideoId2], [IDL2.Vec(Comment2)], ["query"]),
    "getFeed": IDL2.Func([IDL2.Nat, IDL2.Nat], [IDL2.Vec(VideoPublic2)], ["query"]),
    ...
    "getLikeCount": IDL2.Func([VideoId2], [IDL2.Nat], ["query"]),
    "getMyReferralCode": IDL2.Func([], [IDL2.Text], []),
    "getRupeeEquivalent": IDL2.Func([IDL2.Nat], [IDL2.Nat], ["query"]),
    "getTrendingHashtags": IDL2.Func(
      [IDL2.Nat],
    ...
    "getUserVideos": IDL2.Func([UserId2], [IDL2.Vec(VideoPublic2)], ["query"]),
    "getVideo": IDL2.Func([VideoId2], [IDL2.Opt(VideoPublic2)], ["query"]),
    "getWithdrawalHistory": IDL2.Func(
      [],
      [IDL2.Vec(WithdrawalRequestPublic2)],
      ["query"]
    ),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "isFollowing": IDL2.Func([UserId2], [IDL2.Bool], ["query"]),
    "markWithdrawalCompleted": IDL2.Func([WithdrawalId2], [IDL2.Bool], []),
    "recordAdWatch": IDL2.Func([], [IDL2.Nat], []),
    "recordDailyLogin": IDL2.Func([], [IDL2.Nat], []),
    "recordReferralReward": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "recordVideoView": IDL2.Func([VideoId2], [], []),
    "saveCallerUserProfile": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Bool],
      [],
      []
    ),
    "searchUsers": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(UserProfilePublic2)],
      ["query"]
    ),
    "toggleLike": IDL2.Func([VideoId2], [IDL2.Bool], []),
    "unfollowUser": IDL2.Func([UserId2], [IDL2.Bool], []),
    "updateCallerAvatar": IDL2.Func([ExternalBlob2], [], []),
    "uploadVideo": IDL2.Func(
      [ExternalBlob2, IDL2.Text, IDL2.Vec(IDL2.Text)],
      [VideoPublic2],
      []
    )
  });
...
class Backend {
  ...
  async createWithdrawalRequest(arg0) {
    if (this.processError) {
      try {
  ...
  async getTrendingHashtags(arg0) {
    if (this.processError) {
      try {
  ...
  async markWithdrawalCompleted(arg0) {
    if (this.processError) {
      try {
  ...
  async recordReferralReward(arg0) {
    if (this.processError) {
      try {
  ...
  async saveCallerUserProfile(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async uploadVideo(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
async function from_candid_UserProfilePublic_n15(_uploadFile, _downloadFile, value) {
...
async function from_candid_VideoPublic_n22(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n23(_uploadFile, _downloadFile, value);
}
function from_candid_WithdrawalRequestPublic_n10(_uploadFile, _downloadFile, value) {
  return from_candid_record_n11(_uploadFile, _downloadFile, value);
}
function from_candid_WithdrawalStatus_n12(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n25(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n13(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "completed" in value ? "completed" : value;
}
function from_candid_variant_n20(_uploadFile, _downloadFile, value) {
  return "admin" in value ? "admin" : "user" in value ? "user" : "guest" in value ? "guest" : value;
}
async function from_candid_vec_n21(_uploadFile, _downloadFile, value) {
...
async function to_candid_ExternalBlob_n27(_uploadFile, _downloadFile, value) {
